...
public:
  ...
  /** Return dir path for aisnesia.log, etc., respecting -c cli option. */
  wxString& GetPrivateDataDir();

  /** Return dir path for aisnesia.log, etc., does not respect -c option. */
   ...
   * winPluginDir option, defaults to %LOCALAPPDATA%/aisnesia.
   **/
   ...
   * "aisnesia". All paths are guaranteed to exist.
   *
