...
static const char* const kDbusName = "org.aisnesia.AISNESIA";

/** Object representing a running desktop AISNESIA instance. */
static const char* const kDbusObject = "/org/aisnesia/AISNESIA";

/** Dbus interface name, duplicated in introspection_xml. */
static const char* const kDbusInterface = "aisnesia.desktop";

/** Interface description i. e., all methods we support + parameters */
static const gchar introspection_xml[] = R"""(
<node>
  <interface name='aisnesia.desktop'>
