...
public:
  ...
  /** Data for default version, installed with main aisnesia. */
...
protected:
  ...
  const char* const GET_BRANCHES_PATH = "/repos/AISNESIA/plugins/branches";
  const char* const GITHUB_API = "https://api.github.com";

  const char* const REPO_URL = "https://raw.githubusercontent.com";
  const char* const REPO_PATH = "/AISNESIA/plugins/@branch@/ocpn-plugins.xml";
