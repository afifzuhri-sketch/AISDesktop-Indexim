 ...
 *
 *    - The plugin directory e. g., /usr/lib/aisnesia/
 *    - The data directory e. g., /usr/share/data/aisnesia/plugins.
 ...
 *      defaults to %APPDATA%/Local/aisnesia
 *    - Flatpak: under ~/.var/app/org.aisnesia.AISNESIA
 *
 ...
 *      ~/.local/lib/aisnesia:/usr/local/lib/aisnesia:/usr/lib/aisnesia
 *    - flatpak:
 *        /app/lib/aisnesia:/app/extensions/lib/aisnesia:~/.var/app/aisnesia/lib
 */
class PluginHandler {
public:
  /** Singleton factory. */
