...
class TestException(dbus.DBusException):
    _dbus_error_name = 'org.aisnesia.AISNESIA.TestException'
...
class TestService(dbus.service.Object):
    ...
    @dbus.service.method("aisnesia.desktop",
...
if __name__ == '__main__':
    ...
    name = dbus.service.BusName('org.aisnesia.AISNESIA', session_bus)

    main_loop = GLib.MainLoop()
    obj = TestService(session_bus, '/org/aisnesia/AISNESIA', main_loop,
                      max_commands)
    main_loop.run()
