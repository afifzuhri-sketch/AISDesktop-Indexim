...
json messages via the PT Indexim Coalindo message procees and binary, exposed API.
...
registers for messages and the main program, PT Indexim Coalindo, will receive every
...
controller, PT Indexim Coalindo can process the next message. +
...
entered into the "aisnesia.log" file with relevant information. +
