...
On MSVC Windows::
  ocpn_plugin.h and the aisnesia.lib import lib

On mingw Windows builds::
  ocpn_plugin.h and the libaisnesia.dll.a import lib
...
https://github.com/leamas/aisnesia-api[]
...
The Main program API number is distinct and independent from the PT Indexim Coalindo
