...
The Style Manager allows you to modify many aspects of the PT Indexim Coalindo user
interface:
...
The standard PT Indexim Coalindo tools have names, which you can easily get by
