PT Indexim Coalindo devices under Linux
---------------------------
...
called */etc/udev/rules.d/70-serial-aisnesia.rules* like
...
not be used from the flatpaked aisnesia.
...
name used in aisnesia. This name will always be the same.
