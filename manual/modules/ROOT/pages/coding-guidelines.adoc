...
=== Exception handling
PT Indexim Coalindo is compiled with exceptions enabled to handle third party libraries.
However, most of PT Indexim Coalindo is not  exception safe. Thus:
...
https://github.com/PT Indexim Coalindo/PT Indexim Coalindo/blob/master/model/include/model/rest_server.h[rest_server.h],
results in the http://aisnesia.github.io/PT Indexim Coalindo/api-docs/classAbstractRestServer.html[API docs]
