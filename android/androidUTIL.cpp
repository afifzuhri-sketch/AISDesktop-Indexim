 ...
 *
 * Project:  AISNESIA
 * Purpose:  AISNESIA Android support utilities
                    ...
                    wxT("31 Ocean Reef Dr<br>") wxT("# C101-449<br>")
                        wxT("Key Largo, FL 33037-5282<br>")
                            wxT("United States<br><br>")
                                wxT("Please write “source for AISNESIA Version "
...
bool androidUtilInit(void) {
  ...
  if (tk.HasMoreTokens()) {
    ...
    g_androidExtFilesDir =
        token;  // used as PrivateDataDir,
                // "/storage/emulated/0/Android/data/org.aisnesia.aisnesia/files"
                // if app has been moved to sdcard, this gives like (on Android
                // 6) /storage/2385-1BF8/Android/data/org.aisnesia.aisnesia/files
    token = tk.GetNextToken();
  ...
  while (tku.HasMoreTokens()) {
    ...
    if (s1.Find(_T("org.")) != wxNOT_FOUND) {
      if (s1 != _T("org.aisnesia.aisnesia")) g_bstress1 = true;
    }
  }
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_test(JNIEnv *env,
                                                           jobject obj) {
  // qDebug() << "test";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onSoundDone(
...
extern "C" {
JNIEXPORT void JNICALL Java_org_aisnesia_OCPNNativeLib_ImportTmpGPX(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_processSailTimer(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_processNMEA(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_processNMEAInt(
    JNIEnv *env, jobject obj, jstring nmea_string) {
  //  The NMEA message target handler may not be setup yet, if no connections
  //  are defined or enabled. But we may get synthesized messages from the Java
  //  app, even without a definite connection.  We ignore these messages.
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_processBTNMEA(
    JNIEnv *env, jobject obj, jstring nmea_string) {
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_processARBNMEA(
    JNIEnv *env, jobject obj, jstring nmea_string) {
  //  The NMEA message target handler may not be setup yet, if no connections
  //  are defined or enabled. But we may get synthesized messages from the Java
  //  app, even without a definite connection.  We ignore these messages.
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onConfigChange(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onMouseWheel(JNIEnv *env,
                                                                   jobject obj,
                                                                   int dir) {
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onMenuKey(JNIEnv *env,
                                                                jobject obj) {
  //         if(g_MainToolbar){
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onStop(JNIEnv *env,
                                                             jobject obj) {
  qDebug() << "onStop";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_cleanExit(JNIEnv *env,
                                                                jobject obj) {
  qDebug() << "cleanExit";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onStart(JNIEnv *env,
                                                              jobject obj) {
  qDebug() << "onStart";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onPause(JNIEnv *env,
                                                              jobject obj) {
  qDebug() << "onPause";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onResume(JNIEnv *env,
                                                               jobject obj) {
  qDebug() << "onResume";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_onDestroy(JNIEnv *env,
                                                                jobject obj) {
  qDebug() << "onDestroy";
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_selectChartDisplay(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_invokeCmdEventCmdString(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_invokeMenuItem(
...
Java_org_aisnesia_OCPNNativeLib_getVPCorners(JNIEnv *env, jobject obj) {
  //        qDebug() << "getVPCorners";
...
extern "C" {
JNIEXPORT jstring JNICALL Java_org_aisnesia_OCPNNativeLib_getVPS(JNIEnv *env,
                                                                jobject obj) {
  wxString s;
...
extern "C" {
JNIEXPORT int JNICALL Java_org_aisnesia_OCPNNativeLib_getTLWCount(JNIEnv *env,
                                                                 jobject obj) {
  int ret = 0;
...
extern "C" {
JNIEXPORT int JNICALL Java_org_aisnesia_OCPNNativeLib_notifyFullscreenChange(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_setDownloadStatus(
...
extern "C" {
JNIEXPORT jint JNICALL Java_org_aisnesia_OCPNNativeLib_sendPluginMessage(
...
void androidLaunchHelpView() {
  ...
  if (val.IsSameAs(_T("YES"))) {
    ...
    wxString msg =
        _("AISNESIA Help is not installed.\nWould you like to install from "
          "Google PlayStore now?");
    if (androidShowSimpleYesNoDialog(_T("AISNESIA"), msg))
...
wxString androidGetDeviceInfo() {
  ...
  while (tkz.HasMoreTokens()) {
    ...
    if (wxNOT_FOUND != s1.Find(_T("aisnesia"))) {
...
bool androidIsDirWritable(wxString dir) {
  if (g_Android_SDK_Version < 30)
    ...
    // qualification.
    return (dir.Contains("org.aisnesia.aisnesia"));
  }
}
...
void AndroidFileDialog::showDialogJNI(const std::string &startDir,
  ...
  QAndroidJniObject callback("org/aisnesia/FileDialogCallbackProxy", "()V");
  ...
  QAndroidJniObject::callStaticMethod<void>(
      "org/aisnesia/OCPNFileDialog", "showFileDialog",
      "(Landroid/app/Activity;Ljava/lang/String;Lorg/aisnesia/"
...
Java_org_aisnesia_FileDialogCallbackProxy_nativeFileDialogFinished(
...
Java_org_aisnesia_OCPNNativeLib_onSoundFinished(JNIEnv *env, jobject obj) {
...
int doAndroidPersistState() {
  ...
  /*
   ...
   4.  And, of course, aisnesia is going down now.
...
Java_org_aisnesia_OCPNNativeLib_ScheduleCleanExit(JNIEnv *env, jobject obj) {
  qDebug() << "Java_org_aisnesia_OCPNNativeLib_ScheduleCleanExit";
  wxCommandEvent evt(wxEVT_COMMAND_MENU_SELECTED);
  evt.SetId(SCHEDULED_EVENT_CLEAN_EXIT);
  if (g_androidUtilHandler) {
    g_androidUtilHandler->AddPendingEvent(evt);
...
void MigrateAssistantDialog::CreateControls(void) {
  ...
  wxStaticBox *mmsiBox = new wxStaticBox(
      this, wxID_ANY, _("AISNESIA for Android Migration Assistant"));
  ...
  if (m_migrateDirs.GetCount()) {
    wxString infoText1(
        _("AISNESIA has detected chart folders in your configuration file that "
    ...
    wxString migrateMsg1 =
        _("AISNESIA can copy these chart folders to a suitable location, if "
          "desired.");
    migrateMsg1 += "\n\n";
    migrateMsg1 +=
    ...
    wxString migrateMsg1 =
        _("Some chart folders may be inaccessible to AISNESIA on this version "
          "of Android. ");
    migrateMsg1 +=
        _("AISNESIA can copy these chart folders to a suitable location, if "
          "desired.");
  ...
  if (!g_androidGetFilesDirs1.StartsWith("?")) {
    ...
    m_radioInternal =
        new wxRadioButton(this, wxID_ANY, _("AISNESIA Internal Storage"),
                          wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    sourceSizer->Add(m_radioInternal, 0,
                     /*wxEXPAND |*/ wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

    m_radioSDCard =
        new wxRadioButton(this, wxID_ANY, _("AISNESIA SDCard Storage"),
...
Example: /storage/emulated/0/Charts\n\n"));
  ...
  if (wxID_OK == OCPNMessageBox(NULL, clickText1,
                                _("AISNESIA for Android Migration Assistant"),
                                wxOK | wxCANCEL)) {
...
void MigrateAssistantDialog::onPermissionGranted(wxString result) {
  ...
  if (result.StartsWith("file")) {
    ...
    wxString clickText2(
        _("AISNESIA has obtained temporary permission to access the selected "
          "chart folders."));
    clickText2 += "\n\n";
    ...
    clickText2 += "\n\n";
    if (!m_bsdcard)
      clickText2 += _("Destination: AISNESIA Internal Storage");
    else
      clickText2 += _("Destination: AISNESIA SDCard Storage");
    clickText2 += "\n\n";
...
void MigrateAssistantDialog::onTimerEvent(wxTimerEvent &event) {
  ...
  if (m_Status.Contains("Migration complete")) {
    ...
    clickText3 += "\n\n";
    clickText3 += _("Migrated chart folders are now accessible to AISNESIA.");
    clickText3 += "\n";
    clickText3 +=
        _("You may need to adjust your chart folders further, to accommodate "
          "individual chart groups");
    clickText3 += "\n\n";
    clickText3 += _("AISNESIA will now restart to apply changes.");
