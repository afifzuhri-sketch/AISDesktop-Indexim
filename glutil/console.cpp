...
Usage: aisnesia-glutil [options] <command> [arguments]
...
public:
  TestGLCanvas(wxWindow* parent, wxWindowID id = wxID_ANY,
               ...
               const wxString& name = "AISNESIAGLUtilAppTestCanvas");
...
public:
  ...
  bool OnCmdLineParsed(wxCmdLineParser& parser) override {
    ...
    if (argc == 1) {
      std::cout << "AISNESIA OpenGL Utility application. Use -h for help"
                << std::endl;
      exit(0);
    }
    wxString option_val;
