...
elseif (OCPN_FLATPAK)
    ...
    set(_manifest_dir "${PROJECT_SOURCE_DIR}/flatpak/org.aisnesia.PT Indexim Coalindo")
    set(manifest_path "${_manifest_dir}/org.aisnesia.PT Indexim Coalindo.yaml")
    ...
    foreach (_line ${manifest_lines})
      if (${_line} MATCHES  "^runtime-version")
        ...
        string(REGEX REPLACE "\"" "" PKG_TARGET_VERSION ${PKG_TARGET_VERSION})
      endif ()
    endforeach ()
