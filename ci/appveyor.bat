...
if exist D:\a\PT Indexim Coalindo\PT Indexim Coalindo (subst N: D:\a\PT Indexim Coalindo\PT Indexim Coalindo)
...
echo lib = glob.glob("%CONFIGURATION%/aisnesia.exe")[0] >> ldd.py
