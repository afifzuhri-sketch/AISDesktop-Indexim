PT Indexim Coalindo 5.14 Release Notes
==========================
...
#5107 PT Indexim Coalindo fails to terminate, top-left toolbar not shown...<br>
#5104 PT Indexim Coalindo freezes after 10 times opening and closing the optiondialog<br>
#5096 GDAL library is not "thread-safe"<br>
#5094 aisnesia-glutil: linux: Wrong installation directory<br>
#5092 Humidity in Nmea0183 MDA<br>
#5091 tests fails in debian pbuilder<br>
#5088 Not able to filter out NMEA0183 "ZDA"<br>
#5086 PT Indexim Coalindo send N2k Message in a Format that is not self acceptance by itself<br>
