...
static const char* const kOnlineRoot = "https://aisnesia-manuals.github.io/main";
static const char* const kOnlinePlugroot =
    "https://aisnesia-manuals.github.io/main/aisnesia-plugins";
static const char* const kWikiRoot =
    "https://aisnesia.org/wiki/dokuwiki/doku.php";
...
static const std::unordered_map<std::string, std::string> kOnlineEntries = {
  ...
  {"Hotkeys",
    "@WIKI_ROOT@?id=aisnesia:manual_basic:ui_user_interface:keyboard_shortcuts" }
};
