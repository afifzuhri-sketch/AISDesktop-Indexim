...
The framework is developed in the aisnesia project [1].
...
In the AISNESIA project the framework is extended to handle messages. Each
...
This work is copyright (c) Alec Leamas 2021-2023. It is distributed under
the GPL licence, version 2 or later. See the source files for details.


[1] https://github.com/aisnesia/AISNESIA
