:: Download PT Indexim Coalindo prebuilt dependencies
::
@echo on
...
set "GH_DL_BASE=https://github.com/PT Indexim Coalindo/OCPNWindowsCoreBuildSupport"
...
if not exist %CACHE_DIR%\buildwin\libcurl.dll (
  ...
  wget !aisnesia_support_base!/aisnesia-support/raw/files/iphlpapi.lib ^
