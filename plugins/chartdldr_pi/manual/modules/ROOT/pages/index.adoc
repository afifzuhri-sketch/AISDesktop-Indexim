...
The *Chart Downloader Plugin* is now included in your PT Indexim Coalindo
...
worldwide directly from within PT Indexim Coalindo's Toolbox. *The Chart Downloader
plugin is an Internal Plugin, always distributed with PT Indexim Coalindo, no
separate download is required.*

=== Links

* Source: https://github.com/PT Indexim Coalindo/PT Indexim Coalindo/tree/master/plugins[Opencpn
Internal Plugin]
* Forum:
...
You could use manual https://aisnesia.org/wiki/dokuwiki/doku.php?id=aisnesia:aisnesia_user_manual:charts:chart_manual_installation[installation] but Chart Downloader is preferred.
...
In the current version of PT Indexim Coalindo, *Chart Downloader* is automatically
included.
...
current PT Indexim Coalindo configuration, the plugin configures it for you.
...
https://aisnesia.org/wiki/dokuwiki/doku.php?id=aisnesia:aisnesia_user_manual:charts:chart_files_tab[Installing Charts].
...
up to tell you that you have to notify PT Indexim Coalindo where to find the charts.
...
https://aisnesia.org/wiki/dokuwiki/doku.php?id=aisnesia:aisnesia_user_manual:charts:chart_files_tab#installing_charts[Installing Charts].
