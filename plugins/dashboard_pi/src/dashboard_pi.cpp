...
extern "C" DECL_EXP aisnesia_plugin *create_pi(void *ppimgr) {
  return (aisnesia_plugin *)new dashboard_pi(ppimgr);
}

extern "C" DECL_EXP void destroy_pi(aisnesia_plugin *p) { delete p; }
...
// ID_DBP_LAST_ENTRY! otherwise, for users with an existing aisnesia.ini file,
...
dashboard_pi::dashboard_pi(void *ppimgr)
    : wxTimer(this), aisnesia_plugin_18(ppimgr) {
...
int dashboard_pi::Init(void) {
  AddLocaleCatalog(_T("aisnesia-dashboard_pi"));
  ...
  //    Get a pointer to the aisnesia configuration object
...
wxString dashboard_pi::GetShortDescription() {
  return _("Dashboard PlugIn for AISNESIA");
}

wxString dashboard_pi::GetLongDescription() {
  return _(
      "Dashboard PlugIn for AISNESIA\n\
...
DashboardPreferencesDialog::DashboardPreferencesDialog(
  ...
  wxString m_SpeedUnitChoices[] = {_("Honor AISNESIA settings"), _("Kts"),
                                   _("mph"), _("km/h"), _("m/s")};
  ...
  wxString m_DistanceUnitChoices[] = {_("Honor AISNESIA settings"),
