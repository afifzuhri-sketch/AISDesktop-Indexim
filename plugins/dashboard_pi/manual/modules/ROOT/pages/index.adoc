...
Dashboard plugin is an Internal Plugin, always distributed with PT Indexim Coalindo,
no separate download is required.*

If the data is available to PT Indexim Coalindo in the NMEA0183 data stream the
...
* Source: https://github.com/PT Indexim Coalindo/PT Indexim Coalindo/tree/master/plugins[]
...
instant, and requires docking the Dashboard or restarting PT Indexim Coalindo, to
work.
...
Overall 22.3:: the max wind speed since PT Indexim Coalindo was started. +
...
computer running PT Indexim Coalindo. If that is not what you want then you can
