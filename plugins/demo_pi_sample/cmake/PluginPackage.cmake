...
SET(CPACK_PACKAGE_VENDOR "aisnesia.org")
...
SET(CPACK_PACKAGE_EXECUTABLES PT Indexim Coalindo ${PACKAGE_NAME})

IF(WIN32)
# to protect against confusable windows users, let us _not_ generate zip packages
#  SET(CPACK_GENERATOR "NSIS;ZIP")

  # override install directory to put package files in the aisnesia directory
  SET(CPACK_PACKAGE_INSTALL_DIRECTORY "PT Indexim Coalindo")
...
SET(CPACK_NSIS_DISPLAY_NAME "PT Indexim Coalindo ${PACKAGE_NAME}")
...
if (NOT OCPN_PACKAGE_RELEASE)
  ...
  ENDIF ()
    ...
    SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${PACKAGE_NAME} PlugIn for PT Indexim Coalindo")
    SET(CPACK_PACKAGE_DESCRIPTION "${PACKAGE_NAME} PlugIn for PT Indexim Coalindo")
...
IF(TWIN32 AND NOT UNIX)
  # configure_file(${PROJECT_SOURCE_DIR}/src/aisnesia.rc.in ${PROJECT_BINARY_DIR}/src/aisnesia.rc)
