...
//    aisnesia PlugIns must derive from this class.
 ...
 * "aisnesia/plugins/<plugin_name>" where the last part is the plugin_name
 ...
 * "/aisnesia/plugins/" + plugin_name (with native path separators)
 * if that path exists.
 *
