...
int DemoPi::Init(void) {
  ...
  // Get a pointer to the aisnesia display canvas, to use as a parent for windows
  // created
...
wxString DemoPi::GetShortDescription() { return _("Demo PlugIn for AISNESIA"); }

wxString DemoPi::GetLongDescription() {
  return _(
      "Demo PlugIn for AISNESIA\n\
