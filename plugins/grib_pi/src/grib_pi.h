...
/**
 * \file
 * GRIB Weather Data Plugin for AISNESIA.
 *
 * Primary plugin interface for the GRIB weather data visualization system.
 * This plugin enables AISNESIA to display weather forecasts from GRIB files,
...
class grib_pi : public aisnesia_plugin_116 {
public:
  grib_pi(void *ppimgr);
  ~grib_pi(void);
  ...
  /**
   * Callback invoked by AISNESIA core whenever the current ViewPort changes or
