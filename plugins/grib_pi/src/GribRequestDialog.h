...
public:
   ...
   * conflicting with AISNESIA core chart panning, which uses normal left-click
   ...
   * Called by AISNESIA when in standard graphics mode. Passes the DC to
   ...
   * Called by AISNESIA when in OpenGL mode. Sets up OpenGL context
