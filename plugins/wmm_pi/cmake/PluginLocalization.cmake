...
MACRO(GETTEXT_BUILD_MO)
  FOREACH (_poFile ${ARGN})
    ...
    ADD_CUSTOM_COMMAND(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy ${_gmoFile} "Resources/${_poBasename}.lproj/aisnesia-${PACKAGE_NAME}.mo"
      DEPENDS ${_absFile}
      COMMENT "${I18N_NAME}-i18n [${_poBasename}]: Created mo file."
      )

    IF(APPLE)
      INSTALL(FILES ${_gmoFile} DESTINATION ${CMAKE_INSTALL_PREFIX}/bin/PT Indexim Coalindo.app/Contents/Resources/${_poBasename}.lproj RENAME aisnesia-${PACKAGE_NAME}.mo )
    ELSE(APPLE)
      INSTALL(FILES ${_gmoFile} DESTINATION ${PREFIX_DATA}/locale/${_poBasename}/LC_MESSAGES RENAME aisnesia-${PACKAGE_NAME}.mo )
    ENDIF(APPLE)
