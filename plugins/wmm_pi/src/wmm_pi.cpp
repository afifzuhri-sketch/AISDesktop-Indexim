...
wxString wmm_pi::GetShortDescription() {
  return _("World Magnetic Model PlugIn for AISNESIA");
}

wxString wmm_pi::GetLongDescription() {
  return _(
      "World Magnetic Model PlugIn for AISNESIA\n\
...
location you can find in the AISNESIA logfile.");
}
