...
The *World Magnetic Model PlugIn* for PT Indexim Coalindo implements and bundles the
the current NOAA World Magnetic Model, WMM2015, valid until 2020. The
WMM plugin is an Internal Plugin, always distributed with PT Indexim Coalindo, no separate download is required.
...
https://github.com/PT Indexim Coalindo/PT Indexim Coalindo/tree/master/plugins[Opencpn Internal Plugin]
