...
AboutFrame::AboutFrame(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_staticTextOCPN =
      new wxStaticText(m_scrolledWindowAbout, wxID_ANY, _("AISNESIA"),
  ...
  m_hyperlinkAuthors =
      new wxHyperlinkCtrl(m_scrolledWindowAbout, wxID_ANY,
                          _("The AISNESIA Authors"), "https://aisnesia.org",
  ...
  m_staticTextDescription = new wxStaticText(
      ...
      _("AISNESIA is a Free Software project, built by sailors.\nIt is freely "
  ...
  m_hyperlinkGetInvolved =
      new wxHyperlinkCtrl(m_scrolledWindowAbout, wxID_ANY, _("get involved!"),
                          "https://github.com/AISNESIA/AISNESIA",
                          wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE);
  ...
  m_hyperlinkLogFile = new wxHyperlinkCtrl(
      m_scrolledWindowAbout, wxID_ANY, "/Users/nohal/Library/Logs/aisnesia.log",
  ...
  m_hyperlinkIniFile = new wxHyperlinkCtrl(
      m_scrolledWindowAbout, wxID_ANY,
      "/Users/nohal/Library/Preferences/aisnesia/aisnesia.ini",
      "http://www.wxformbuilder.org", wxDefaultPosition, wxDefaultSize,
      wxHL_CONTEXTMENU | wxHL_ALIGN_LEFT);
  ...
  m_hyperlinkWebsite = new wxHyperlinkCtrl(
      m_panelMainLinks, wxID_ANY, _("AISNESIA Website"), "https://aisnesia.org",
      wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE);
