...
An AISNESIA dongle is detected but cannot be used due to missing permissions.
...
public:
  Buttons(wxWindow* parent, const char* rule_path)
    ...
    quit->Bind(wxEVT_COMMAND_BUTTON_CLICKED, [&](wxCommandEvent& ev) {
      if (getenv("FLATPAK_ID")) {
        ...
        OCPNMessageBox(this, msg, _("AISNESIA"), flags);
      }
  ...
  void DoInstall() {
    ...
    OCPNMessageBox(this, msg, _("AISNESIA Info"), flags);
  }
