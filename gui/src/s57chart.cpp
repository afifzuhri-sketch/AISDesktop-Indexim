...
static void AISNESIA_OGRErrorHandler(
            ...
            (flen > 25))  // a valid update file or base file
        {
          ...
          if (!chain_broken_mssage_shown) {
            OCPNMessageBox(
                ...
                _("AISNESIA Create SENC Warning"), wxOK | wxICON_EXCLAMATION,
                30);
...
static void AISNESIA_OGRErrorHandler(CPLErr eErrClass, int nError,
