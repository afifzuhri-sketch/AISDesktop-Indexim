...
static wxString AISNESIAVersion("\n      Version ");

// clang-format off

static const wxString AboutText =
    "<br>AISNESIA<br>"
    "(c) 2000-2024  The AISNESIA Authors<br><br>";

static const wxString AISNESIAInfo =
    "<br><br>"
    "AISNESIA is a Free Software project, built by sailors. "
    "It is freely available to download and distribute "
    "without charge at aisnesia.org.<br><br>"
    "If you use AISNESIA, please consider contributing "
    "or donating funds to the project.<br><br>"
    "For more information, visit http://aisnesia.org<br><br>";

static const wxString AISNESIAInfoAlt =
    "<br><br>"
    "AISNESIA is a Free Software project, built by sailors."
...
About::About(wxWindow* parent, wxString Data_Locn,
  ...
  if (strlen(DEBIAN_PPA_VERSION))
    AISNESIAVersion += wxString(DEBIAN_PPA_VERSION);
  else
    AISNESIAVersion += wxString(PACKAGE_VERSION);
...
void About::Populate() {
  ...
  wxString AISNESIAVersionAndroid =
      "AISNESIA for Android Version " + androidGetVersionName() + msg;

  aboutText.Append(AboutText + AISNESIAVersionAndroid + AISNESIAInfoAlt);
#else
  aboutText.Append(AboutText + AISNESIAVersion + AISNESIAInfo);
#endif
