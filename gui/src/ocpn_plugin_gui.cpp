...
int AddCanvasMenuItem(wxMenuItem* pitem, aisnesia_plugin* pplugin,
                      const char* name) {
  if (s_ppim)
...
int AddCanvasContextMenuItem(wxMenuItem* pitem, aisnesia_plugin* pplugin) {
...
int AddCanvasContextMenuItemExt(wxMenuItem* pitem, aisnesia_plugin* pplugin,
