...
void MMSIEditDialog::CreateControls() {
  ...
  m_cbTrackPersist->SetToolTip(
      _("Save this vessel's track between AISNESIA sessions. Useful for vessels "
  ...
  m_MOBButton->SetToolTip(
      _("When checked, AISNESIA will display a special icon for this device, "
...
static const wxString BAD_ACCESS_MSG = _(
    "The device selected is not accessible; aisnesia will likely not be able\n"
    "to use this device as-is. You might want to exit AISNESIA, reboot and\n"
    "retry after creating a file called /etc/udev/rules.d/70-aisnesia.rules\n"
...
void options::ApplyChanges(wxCommandEvent& event) {
  ...
  if (m_pShipIconType->GetSelection() > 0) {
    ...
    if (!msg.IsEmpty()) {
      ...
      OCPNMessageBox(this, msg, _("AISNESIA info"), wxICON_ERROR | wxOK);
      ::wxEndBusyCursor();
...
void options::DoDBSUpdate(bool force_full) {
  ...
  wxString longmsg = _("AISNESIA Chart Update");
  longmsg +=
      ".................................................................."
      "........";
  ...
  //
  m_pCBDSprog->Create(_("AISNESIA Chart Update"), longmsg, 100, nullptr,
                      wxPD_SMOOTH);
...
void options::OnButtonEcdisHelp(wxCommandEvent& event) {
  ...
  if (!::wxFileExists(testFile)) {
    ...
    if (wxID_YES == OCPNMessageBox(NULL, msg, _("Inland ECDIS Manual"),
      ...
      wxLaunchDefaultBrowser("https://aisnesia-manuals.github.io/inland-ecdis");
    }
  } else {
#ifdef __WXMSW__
...
This may make them incompatible with other programs or older versions of AISNESIA.\n\
...
They can be decompressed again using unxz or 7 zip programs."),
  ...
  wxGenericProgressDialog prog1(
      _("AISNESIA Compress Charts"), wxEmptyString,
  ...
  if (charts.GetCount() == 0) {
    OCPNMessageBox(this, _("No charts found to compress."), _("AISNESIA Info"));
    return;
  }
  ...
  wxGenericProgressDialog prog(
      _("AISNESIA Compress Charts"), wxEmptyString, charts.GetCount() + 1, this,
      wxPD_SMOOTH | wxPD_ELAPSED_TIME | wxPD_ESTIMATED_TIME |
          wxPD_REMAINING_TIME | wxPD_CAN_SKIP);
    ...
    if (!m_bVisitLang) {
      ...
      for (int it = 1; it < nLang; it++) {
        if (wxLocale::IsAvailable(lang_list[it])) {
          ...
          ltest.AddCatalog("aisnesia");
          if (!ltest.IsLoaded("aisnesia")) continue;
      ...
      plocale_def_lang->AddCatalog("aisnesia");
...
OpenGLOptionsDlg::OpenGLOptionsDlg(wxWindow* parent)
  ...
  m_cbSoftwareGL =
      new wxCheckBox(this, wxID_ANY, _("Software OpenGL (restart AISNESIA)"));
