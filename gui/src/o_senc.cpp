...
/************************************************************************/
/*                       AISNESIA_OGRErrorHandler()                      */
/*                       Use Global wxLog Class                         */
/************************************************************************/

void AISNESIA_OGR_OSENC_ErrorHandler(CPLErr eErrClass, int nError,
...
void Osenc::init() {
  ...
  CPLPushErrorHandler(AISNESIA_OGR_OSENC_ErrorHandler);
    ...
    if (last_successful_update_file.Length()) {
      ...
      if (!m_NoErrDialog) {
        OCPNMessageBox(
            ...
            _("AISNESIA Create SENC Warning"), wxOK | wxICON_EXCLAMATION, 5);
      }
      ...
      if (!m_NoErrDialog)
        OCPNMessageBox(NULL,
                       _("S57 Cell Update failed.\nNo updates could be "
                         "applied.\nENC features may be incomplete or "
                         "inaccurate.\n\nCheck the logfile for details."),
                       _("AISNESIA Create SENC Warning"),
...
//---------------------------------------------------------------------------------------------------
/*
 *      AISNESIA OSENC Version 2 Implementation
 */
//---------------------------------------------------------------------------------------------------
...
int Osenc::createSenc200(const wxString &FullPath000,
  ...
  wxString Title(_("AISNESIA S57 SENC File Create..."));
