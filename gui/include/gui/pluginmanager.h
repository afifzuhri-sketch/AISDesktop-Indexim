...
public:
  ...
  aisnesia_plugin* FindToolOwner(const int id);
  ...
  int AddCanvasContextMenuItemPIM(wxMenuItem* pitem, aisnesia_plugin* pplugin,
                                  const char* name = "",
  ...
  aisnesia_plugin* GetProvidingPlugin(const wxString& ChartClassName);
...
private:
  ...
  bool CheckBlacklistedPlugin(aisnesia_plugin* plugin);
